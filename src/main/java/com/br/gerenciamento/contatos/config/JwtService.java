...
import com.br.gerenciamento.contatos.GerenciamentoContatosApplication;
...
public class JwtService {
   ...
   private  Claims obterClaims( String token ) throws ExpiredJwtException {
    ...
    public static  void main (String[] args ){
        ConfigurableApplicationContext context = SpringApplication.run(GerenciamentoContatosApplication.class);
